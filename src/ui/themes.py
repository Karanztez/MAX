...
DARK: dict[str, str] = dict(
    ...
    sub="#9aa0a6",           # Subtitle / dimmed text
...
LIGHT: dict[str, str] = dict(
    ...
    sub="#5f6368",           # Subtitle / dimmed text
...
# Typography (Clean Minimalist Proportional Style)
FONT = ("Segoe UI", 10)
...
FONT_H1 = ("Segoe UI Semibold", 12, "bold")
FONT_H2 = ("Segoe UI Semibold", 11, "bold")
FONT_H3 = ("Segoe UI Semibold", 10, "bold")
FONT_CODE_INLINE = ("Consolas", 9)
FONT_QUOTE = ("Segoe UI", 9, "italic")
